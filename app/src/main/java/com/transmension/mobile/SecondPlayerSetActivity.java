...
public class SecondPlayerSetActivity extends Activity {
    ...
    private final String[] preferenceNames1P = new String[]{"P1A", "P1B", "P1X", "P1L1", "P1R1", "P1UP", "P1DOWN", "P1LEFT", "P1RIGHT", "P2A", "P2B", "P2X", "P2L1", "P2R1", "P2UP", "P2DOWN", "P2LEFT", "P2RIGHT"};
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode != 4 && keyCode != 82 && event.getRepeatCount() == 0) {
            if (keyToSet != null) {
                SharedPreferences sharedPreferences = getSharedPreferences("data", 0);
                keyToSet.setText(String.format("%s: %s", preferenceIntros1P[keyToSet.preferenceId], keyCode == KeyEvent.KEYCODE_UNKNOWN ? getString(R.string.secondplayer_default) : KeyEvent.keyCodeToString(keyCode).replace("KEYCODE_", "")));
