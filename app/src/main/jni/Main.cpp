...
Java_com_android_support_CkHomuraMenu_GetFeatureList(JNIEnv *env, jobject thiz) {
    ...
    const char *features[] = {
            ...
            "1_CollapseAdd_Toggle_阳光无限",
            "2_CollapseAdd_Toggle_取消冷却",
            "83_CollapseAdd_Toggle_自由种植",
            "110_CollapseAdd_Toggle_无视进家",
            "115_CollapseAdd_Toggle_蘑菇免唤醒",
            "23_CollapseAdd_OnceCheckBox_过了这关",

            "Collapse_游戏调试",//**
            "81_CollapseAdd_Toggle_出僵DEBUG",
            "119_CollapseAdd_Toggle_罐子透视",
            "121_CollapseAdd_Toggle_僵尸显血",
            "122_CollapseAdd_Toggle_植物显血",
            "116_CollapseAdd_Toggle_时间暂停",
            "117_CollapseAdd_Toggle_普僵必噎死",
            "124_CollapseAdd_Toggle_绘制碰撞体积",
            "111_CollapseAdd_Toggle_禁止掉落阳光金币",
            "112_CollapseAdd_OnceCheckBox_跳关器",
            "113_CollapseAdd_OnceCheckBox_作弊码",
            "114_CollapseAdd_Spinner_<font color='green'>倍速：_关闭,1.2倍,1.5倍,2倍,2.5倍,3倍,5倍,10倍",
            "118_CollapseAdd_Spinner_<font color='green'>更换场地：_关闭,前院白天,前院夜晚,泳池白天,泳池夜晚,屋顶白天,屋顶夜晚",
            "123_CollapseAdd_Spinner_<font color='green'>进家线退后：_关闭,10,20,30,40,50,60,70,80",

            "Collapse_子弹功能",
            "120_CollapseAdd_Toggle_直线子弹帧伤",
            "50_CollapseAdd_Toggle_随机子弹",
            "51_CollapseAdd_Spinner_<font color='green'>固定某种子弹：_关闭,豌豆,冰豌豆,卷心菜,西瓜,泡泡,冰西瓜,火豌豆,星星,尖刺,只因球,玉米粒,玉米炮,黄油,自残子弹",
            "86_CollapseAdd_Toggle_穿火炬生效(Pea)",
            "87_CollapseAdd_Toggle_冰豆跃火",
            "55_CollapseAdd_CheckBox_仅对豌豆生效",
            "84_CollapseAdd_CheckBox_Ban加农",
            "85_CollapseAdd_CheckBox_Ban杨桃",

            "Collapse_布阵搭梯",
            "52_CollapseAdd_OnceCheckBox_清空场上植物",
            ...
            "CollapseAdd_RichTextView_<font color='yellow'>搭梯功能:",
            "61_CollapseAdd_Toggle_种下南瓜自动搭梯",
            "62_CollapseAdd_InputValue_搭梯X坐标",
            "63_CollapseAdd_InputValue_搭梯Y坐标",
            "64_CollapseAdd_OnceCheckBox_搭梯",
            "CollapseAdd_RichTextView_<font color='yellow'>无尽跳关:",
            "125_CollapseAdd_InputValue_目标关数",
            "126_CollapseAdd_OnceCheckBox_跳关",
            "CollapseAdd_RichTextView_<font color='yellow'>#已过至少一关后才能跳关!",

            "Collapse_植僵建造",
            "CollapseAdd_RichTextView_<font color='yellow'>植物:--->",
            "65_CollapseAdd_Spinner_<font color='green'>选择建造植物：_关闭,豌豆射手,向日葵,樱桃炸弹,坚果,土豆地雷,寒冰射手,食人花,双发射手,小喷菇,阳光菇,大喷菇,咬咬碑,迷惑菇,胆小菇,冰冻菇,毁灭菇,睡莲,窝瓜,三线射手,海藻,火爆辣椒,地刺,火炬树桩,高坚果,海蘑菇,灯笼草,仙人掌,三叶草,双向射手,杨桃,南瓜套,磁力菇,卷心菜,花盆,玉米投手,咖啡豆,大蒜,叶子保护伞,金盏花,西瓜投手,机枪射手,双子向日葵,忧郁蘑菇,猫尾草,冰冻西瓜,吸金瓷,地刺王,玉米加农炮,模仿者,爆炸坚果,巨型坚果,树苗,反向双发射手",
            "66_CollapseAdd_InputValue_自定义植物ID",
